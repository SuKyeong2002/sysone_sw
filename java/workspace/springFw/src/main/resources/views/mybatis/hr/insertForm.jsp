...
<html>
	...
	<form action="./insert" method="post">
		<table border="1">
			<tr>
			    <th>EMPLOYEE_ID</th>
			    <td><input type="number" name="employeeId" required max="99999"></td>
			</tr>
			<tr>
			    <th>FIRST_NAME</th>
			    <td><input type="text" name="firstName" maxlength="10" placehodler="성을 입력하세요"></td>
			</tr>
			<tr>
			    <th>LAST_NAME</th>
			...
			<tr>
			    <th>PHONE_NUMBER</th>
			    <td><input type="text" name="phoneNumber" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}"></td>
			</tr>
			<tr>
			    <th>HIRE_DATE</th>
			...
			<tr>
			    <th>SALARY</th>
			    <td><input type="number" name="salary" min="0" value="0"></td>
			</tr>
			<tr>
