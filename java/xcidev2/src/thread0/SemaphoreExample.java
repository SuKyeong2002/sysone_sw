...
public class SemaphoreExample {
	...
	private static void accessResource() {
		try {
			...
			System.out.println(
					Thread.currentThread().getName() + " is accessing the resource" + System.currentTimeMillis());
			...
			System.out.println(
					Thread.currentThread().getName() + " is releasing the resource" + System.currentTimeMillis());
		}
	}
}